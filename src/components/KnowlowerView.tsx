    ...
    <div className="min-h-screen bg-[#050505] text-zinc-400 p-4 md:p-12 font-sans selection:bg-amber-500/30">
      ...
      <div className="max-w-7xl mx-auto">
        {loading ? (
          ...
          <div className="bg-zinc-900/20 border border-zinc-800/40 rounded-[32px] overflow-hidden backdrop-blur-3xl">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-zinc-900/60">
                  <th className="px-8 py-5 text-[10px] font-black text-zinc-600 uppercase tracking-widest border-b border-zinc-800/50">Pregunta</th>
                  <th className="px-8 py-5 text-[10px] font-black text-zinc-600 uppercase tracking-widest border-b border-zinc-800/50">Respuesta Definida</th>
                  <th className="px-8 py-5 text-[10px] font-black text-zinc-600 uppercase tracking-widest border-b border-zinc-800/50 text-center">Tag</th>
                  <th className="px-8 py-5 text-[10px] font-black text-zinc-600 uppercase tracking-widest border-b border-zinc-800/50 text-right">Estatus</th>
                </tr>
              </thead>
