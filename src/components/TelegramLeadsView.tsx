      ...
      <div className="max-w-7xl mx-auto mb-10">
        <div className="flex justify-between items-start mb-8">
          <div>
            <h1 className="text-2xl sm:text-4xl font-black text-gray-900 tracking-tighter italic">
              PIPELINE <span className="text-gray-300 not-italic font-thin">Telegram</span>
            </h1>
        ...
        <div className="flex flex-wrap gap-4 items-center bg-gray-50 p-4 rounded-2xl border border-gray-200">
          ...
          <select
            ...
            className="bg-white border border-gray-200 text-gray-700 text-xs rounded-lg px-3 py-2 outline-none focus:border-amber-500"
          >
