      ...
      <div className="max-w-7xl mx-auto mb-10">
        ...
        <div className="flex flex-wrap gap-4 items-center bg-zinc-900/40 p-4 rounded-2xl border border-zinc-800/50 backdrop-blur-md">
          ...
          <select
            ...
            className="bg-black border border-zinc-800 text-zinc-300 text-xs rounded-lg px-3 py-2 outline-none focus:border-green-500/50"
          >
              ...
              {leads.map((lead) => {
                ...
                return (
                  <tr key={lead.id} className="group hover:bg-white/[0.01] transition-all">
                    ...
                    <td className="px-4 sm:px-8 py-4 sm:py-6">
                      <div className="text-green-500/90 text-sm font-semibold tracking-tight">
