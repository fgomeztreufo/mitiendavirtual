...
export default function FaqsView({ session }: FaqsViewProps) {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Preguntas Frecuentes (FAQ)</h2>
        <p className="text-gray-500">Entrena a tu IA subiendo un archivo .txt con el formato Pregunta | Respuesta.</p>
      </header>

      <div className="bg-white border border-gray-200 shadow-sm rounded-2xl p-8 max-w-2xl">
        {/* ÁREA DE CARGA */}
        <div className="relative flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-xl p-10 hover:border-indigo-500 transition-colors group">
          ...
          <svg className="w-12 h-12 text-gray-400 group-hover:text-indigo-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {file && (
            <div className="flex gap-2 z-20">
                ...
                <button onClick={() => setFile(null)} className="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg">Cancelar</button>
            </div>
          )}
        </div>
        ...
        <div className="mt-8 flex items-center justify-between border-t border-gray-200 pt-6">
            <div className="text-sm text-gray-400">
                <p>Formato: <span className="text-indigo-600 font-mono">Pregunta | Respuesta</span></p>
            </div>
            ...
            <button
                ...
                className="relative z-30 text-sm text-indigo-600 hover:text-indigo-500 flex items-center gap-1 font-medium p-2"
            >
